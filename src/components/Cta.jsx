...
const Cta = () => {
  return (
    <section className='py-76 bg-primary-light_coral relative'>
      <img width={200} height={144} src={circleShape} className='absolute bottom-0 left-0 object-cover object-top h-144' alt="circle shape" />
      <div className="flex justify-between items-center max-w-917 w-full px-5 mx-auto">
